...
pub fn build(b: *Builder) void {
    ...
    const run_cmd = [_][]const u8{ "qemu-system-i386", "-machine", "q35,acpi=on", "-debugcon", "stdio", "-cdrom", "zig-out/NyaOS.iso" };
    const debug_cmd = [_][]const u8{ "qemu-system-i386", "-machine", "q35,acpi=on", "-d", "int", "-s", "-S", "-debugcon", "stdio", "-kernel", "zig-out/extra/kernel.elf" };
