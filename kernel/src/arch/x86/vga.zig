const biosInt = @import("biosINT.zig");
...
pub fn testGraphics() void {
    var regs: biosInt.regs16 = .{};
    regs.ax = 0x0013;
    biosInt.int32Wrapper(0x10, &regs);

    var vbuffer = @as([*]volatile u16, @ptrFromInt(0xC00A0000));

    @memset(vbuffer[0..(320 * 200)], 1);
